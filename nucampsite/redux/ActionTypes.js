// all possible action objects we can dispatch to reducers to let the application know our current state, including when we are loading data, adding dat, or data fetching had failed
